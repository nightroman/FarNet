...
'FarHome\FarNet\Modules\PowerShellFar\Bench\Invoke-FromEditor.ps1'
...
'FarHome\FarNet\Modules\PowerShellFar\Bench\Merge-Selected.ps1'
...
'FarNet\Modules\PowerShellFar\Bench\Invoke-FromEditor.ps1'
...
'FarNet\Modules\PowerShellFar\Bench\Merge-Selected.ps1'
