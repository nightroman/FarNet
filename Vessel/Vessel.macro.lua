...
Macro { area="Common"; key="AltF11"; flags="DisableOutput"; description="Vessel: Smart file history"; action=function()
...
Macro { area="Common"; key="CtrlShiftF11"; description="Vessel: Standard file history"; action=function()
Keys("AltF11")
end;}
