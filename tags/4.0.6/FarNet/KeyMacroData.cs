...
namespace FarNet
{
	...
	public class KeyMacroData
	{
		...
		{
			get { return _DisablePlugins; }
			set { _DisablePlugins = value; }
		}

		bool _RunAfterFarStart;
		/// <summary>
		/// Execute macro command after FAR startup. This flag is only for macros in the Shell area.
		/// </summary>
		public bool RunAfterFarStart
		{
			get { return _RunAfterFarStart; }
			set { _RunAfterFarStart = value; }
		}
		...
		public string CommandLine
		{
			...
			set { _CommandLine = ToThreeState(value); }
		}
		...
		public string SelectedText
		{
			...
			set { _SelectedText = ToThreeState(value); }
		}
		...
		public string SelectedItems
		{
			...
			set { _SelectedItems = ToThreeState(value); }
		}
		...
		/// Empty string (default): execute the macro in both cases.
		/// </summary>
		public string PanelIsPlugin
		{
			get { return _PanelIsPlugin; }
			set { _PanelIsPlugin = ToThreeState(value); }
		}
		...
		/// Empty string (default): execute the macro in both cases.
		/// </summary>
		public string ItemIsDirectory
		{
			get { return _ItemIsDirectory; }
			set { _ItemIsDirectory = ToThreeState(value); }
		}
		...
		{
			get { return _SelectedItems2; }
			set { _SelectedItems2 = ToThreeState(value); }
		}
		...
		/// Empty string (default): execute the macro in both cases.
		/// </summary>
		public string PanelIsPlugin2
		{
			get { return _PanelIsPlugin2; }
			set { _PanelIsPlugin2 = ToThreeState(value); }
		}
		...
		/// Empty string (default): execute the macro in both cases.
		/// </summary>
		public string ItemIsDirectory2
		{
			get { return _ItemIsDirectory2; }
			set { _ItemIsDirectory2 = ToThreeState(value); }
		}
		...
		static string ToThreeState(string value)
		{
			...
			switch (value)
			{
				...
				case "1":
					return "1";
				default:
					throw new FormatException("Valid values are: '0', '1', empty string or null.");
			}
		}
	}
}
