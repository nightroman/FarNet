...
namespace FarNet.Forms
{
	...
	public interface IBox : IControl
	{
		...
		/// <include file='doc.xml' path='docs/pp[@name="ShowAmpersand"]/*'/>
	...
	{
		/// <include file='doc.xml' path='docs/pp[@name="ButtonClicked"]/*'/>
		...
		/// <include file='doc.xml' path='docs/pp[@name="CenterGroup"]/*'/>
		bool CenterGroup { get; set; }
		/// <summary>
		/// Tells to display the button without brackets.
		/// </summary>
		bool NoBrackets { get; set; }
		/// <include file='doc.xml' path='docs/pp[@name="NoFocus"]/*'/>
	...
	public interface IEdit : IControl
	{
		...
		/// <include file='doc.xml' path='docs/pp[@name="ReadOnly"]/*'/>
		bool ReadOnly { get; set; }
		/// <include file='doc.xml' path='docs/pp[@name="SelectOnEntry"]/*'/>
