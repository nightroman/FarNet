...
namespace FarNet.Works
{
	...
	{
		protected readonly List<FarItem> myItems = new List<FarItem>();
		protected readonly List<KeyData> myKeys = new List<KeyData>();
		protected readonly List<EventHandler<MenuEventArgs>> myHandlers = new List<EventHandler<MenuEventArgs>>();
