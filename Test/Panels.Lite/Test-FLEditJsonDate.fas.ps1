...
job {
	...
	Assert-Far $__.Line.Text -eq '  "line1": {"$date": "2020-02-17T06:10:00.0000000Z"},'
}
macro 'Keys"F4" -- edit line'
job {
	# another editor with simpler date
	Assert-Far $__.Line.Text -eq '2020-02-17 06:10:00'
	# change
	$__.Line.Text = '2020-01-01'
}
macro 'Keys"Esc Enter" -- exit, save'
job {
	# edited
	Assert-Far $__.Line.Text -eq '  "line1": {"$date": "2020-01-01T00:00:00.0000000Z"},'
}
