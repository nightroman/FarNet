...
job {
	Assert-Far ($Far.Panel.ShownFiles -join ' ') -eq '1 2 3'
}

# sort
macro 'Keys"F1 s C a t e g o r y Enter"'
job {
	Assert-Far ($Far.Panel.ShownFiles -join ' ') -eq '3 1 2'
}
...
'@
job {
	Assert-Far ($Far.Panel.ShownFiles -join ' ') -eq '3 2'
}
...
job {
	Assert-Far -FileDescription Warning
	Assert-Far ($Far.Panel.ShownFiles -join ' ') -eq '5 3 2'
}
