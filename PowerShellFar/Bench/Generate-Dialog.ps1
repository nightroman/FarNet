...
.Description
	...
	'Invoke commands', type and invoke Generate-Dialog.ps1.

	The default output file is GeneratedDialog.far.ps1 in the local module
	folder. Normally it is ready to start code to show a dialog that looks
	like the original one.

.Parameter OutputPath
		Specifies the generated file path.
#>

[CmdletBinding()]
param(
	$OutputPath = "$($Psf.Manager.GetFolderPath(0, 1))\GeneratedDialog.far.ps1"
)
