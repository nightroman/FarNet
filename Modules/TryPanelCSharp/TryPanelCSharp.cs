...
public class MyExplorer : Explorer
{
	...
	public MyExplorer() : base(new Guid("4bbffcb1-3570-4a95-8692-ccdd0c234a95"))
	{
		CanCreateFile = true;
		CanDeleteFiles = true;
...
{
	public MyPanel(Explorer explorer) : base(explorer)
	{
...
[ModuleTool(Name = "TryPanelCSharp", Options = ModuleToolOptions.F11Menus, Id = "8f7ba3b1-7fe9-4912-9f30-b2f43ef47000")]
