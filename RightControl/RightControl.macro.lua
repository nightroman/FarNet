...
Macro {
  key="CtrlBS"; description="RightControl: delete left"; area=areaAnyEditor; condition=isEditor;
  action=function()
...
Macro {
  key="CtrlDel"; description="RightControl: delete right"; area=areaAnyEditor; condition=isEditor;
  action=function()
    if Area.DialogAutoCompletion or Area.ShellAutoCompletion then Keys("Esc") end
...
Macro {
  key="CtrlLeft"; description="RightControl: step left"; area=areaAnyEditor; condition=isEditor;
  action=function()
    if Area.DialogAutoCompletion or Area.ShellAutoCompletion then Keys("Esc") end
...
Macro {
  key="CtrlRight"; description="RightControl: step right"; area=areaAnyEditor; condition=isEditor;
  action=function()
    if Area.DialogAutoCompletion or Area.ShellAutoCompletion then Keys("Esc") end
...
Macro {
  key="CtrlShiftLeft"; description="RightControl: select left"; area=areaAnyEditor; condition=isEditor;
  action=function()
    if Area.DialogAutoCompletion or Area.ShellAutoCompletion then Keys("Esc") end
...
Macro {
  key="CtrlShiftRight"; description="RightControl: select right"; area=areaAnyEditor; condition=isEditor;
  action=function()
    if Area.DialogAutoCompletion or Area.ShellAutoCompletion then Keys("Esc") end
...
Macro {
  area="Editor"; key="CtrlAltLeft"; description="RightControl: vertical left";
  action=function()
...
Macro {
  area="Editor"; key="CtrlAltRight"; description="RightControl: vertical right";
  action=function()
...
Macro {
  area="Editor"; key="Home"; description="RightControl: go to smart home";
  action=function()
...
Macro {
  area="Editor"; key="ShiftHome"; description="RightControl: select to smart home";
  action=function()
