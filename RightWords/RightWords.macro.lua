...
Macro {
key="CtrlShiftSpace"; description="RightWords: Correct word"; area=areaAnyEditor; condition=isEditor; action=function()
...
Macro {
area="Editor"; key="CtrlShiftF7"; description="RightWords: Correct text"; action=function()
if Plugin.Menu("10435532-9BB3-487B-A045-B0E6ECAAB6BC", "CA7ECDC0-F446-4BFF-A99D-06C90FE0A3A9") then
	Keys("2")
end
end;
...
Macro {
area="Editor"; key="CtrlShiftH"; description="RightWords: Highlighting"; action=function()
