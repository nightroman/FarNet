...
The main help topic "Contents" is defined by the `h1` heading.
Its identifier for links is generated by GFM rules.
There must be just one `h1` heading.

Other help topics are defined by `h2` headings.
Their identifies for links are generated by GFM rules.

Generated identifier example: "## My Topic Title" -> "my-topic-title"

### Headings in topics

Headings `h3` - `h6` are used inside topics. All headings are emphasized by
